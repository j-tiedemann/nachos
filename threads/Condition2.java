...
public class Condition2 {
  ...
  private LinkedList<KThread> waitList;
	...
	public Condition2(Lock conditionLock) {
		...
		Lib.debub(dbgC2, Machine.timer().getTime() + "Cnd2 start";
	...
	public void selfTest()
	{
		...
		KThread sleepThread1 = new KThread(new Runnable(){
		...
		).setName("Sleep Test 2");
			System.out.prinlnt("Forking sleepThread 2");
			sleepThread2.fork();
			...
			public void run() {
				...
				System.out.prinlnt("Forking sleepThread3");
				sleepThread3.fork();
			...
			System.out.prinlnt("Forking wakeThread1");
				wakeThread1.fork();
